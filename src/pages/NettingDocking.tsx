...
const pageContent = {
  hero: {
    ...
    description:
      "Our netting and docking services deliver engineered fall-arrest netting, temporary decking, and docking access systems for active construction and maintenance sites. We design each system around your layout, sequence, and risk profile so teams can work safely with minimal disruption.",
  },
  seo: {
    title: "Netting & Docking Services | Temporary Decking, Edge Protection, and Access Safety",
    description:
      "Specialist netting and docking services for civil, commercial, and industrial sites. We provide engineered safety netting, temporary decking, installation, inspection, and ongoing compliance support.",
  },
};
...
const serviceModules = [
  {
    ...
    description:
      "Certified crews install horizontal and vertical safety net systems to reduce fall risk during structural and roofing works.",
  },
  {
    icon: Building,
    title: "Temporary Decking & Void Protection",
    description:
      "Modular temporary decking systems protect floor openings, service penetrations, and incomplete edges while work continues.",
  },
  {
    icon: Wrench,
    title: "Docking Access Setup",
    description:
      "Docking and loading-zone access setups are planned and installed for safer movement of people, materials, and equipment.",
  },
  {
    icon: ClipboardCheck,
    title: "Inspection & Compliance Records",
    description:
      "Routine inspections, tagged handovers, and traceable records help principal contractors maintain clear compliance evidence.",
  },
];
...
const deliveryWorkflow = [
  {
    step: "01",
    title: "Scope Review & Site Risk Assessment",
    detail: "We assess hazard zones, traffic flow, and work sequencing to determine the right netting and docking controls.",
  },
  {
    step: "02",
    title: "Engineered Layout & Method Planning",
    detail: "Our team develops installation layouts, load considerations, and safe work method documentation for approval.",
  },
  {
    step: "03",
    title: "Installation, Tagging & Handover",
    detail: "Certified installers complete the system setup, verify tension/fixings, and issue formal handover documentation.",
  },
  {
    step: "04",
    title: "Ongoing Inspection & Modifications",
    detail: "Scheduled inspections and responsive modifications keep systems compliant as site conditions evolve.",
  },
];
        ...
        <div className="container mx-auto px-4 py-16 md:py-24">
          <motion.div initial="hidden" animate="show" variants={sectionAnim} transition={{ duration: 0.5 }}>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Button asChild>
                <Link to="/contact">
                  Request Netting & Docking Quote <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-sm text-muted-foreground">
                <p className="flex items-start gap-2">
                  ...
                  Competent installation crews with documented safety procedures.
                </p>
                <p className="flex items-start gap-2">
                  <LifeBuoy className="mt-0.5 h-4 w-4 shrink-0 text-primary" />
                  Practical fall-prevention controls tailored to live-site conditions.
                </p>
                <p className="flex items-start gap-2">
                  <Waves className="mt-0.5 h-4 w-4 shrink-0 text-primary" />
                  Solutions suited to industrial, logistics, and marine docking environments.
                </p>
                <p className="flex items-start gap-2">
                  <ClipboardCheck className="mt-0.5 h-4 w-4 shrink-0 text-primary" />
                  Inspection logs and handover records ready for audit and contractor review.
                </p>
              </CardContent>
            </Card>
          </div>
